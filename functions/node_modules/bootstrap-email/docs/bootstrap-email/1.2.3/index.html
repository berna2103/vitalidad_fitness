...
<pre class="prettyprint source lang-javascript"><code>const singleTemplate = new BootstrapEmail('&lt;absolute-path-to-template>.html');
...
<li>[ ] Write cli script</li>
</ul>
<h1>Known Bugs</h1>
<ul>
<li>Outlook 2013 on Windows 10 with 120DPI can't scale images properly</li>
<li>Paddings don't work properly on Outlook (Windows ofc)</li>
<li>Auto-sized tables behave as if they would have width=&quot;100%&quot; on Outlook 2003 (Windows ofc)</li>
<li>Outlook 2003 (Windows) is fucked up in general</li>
</ul>
    </article>
  </section>
