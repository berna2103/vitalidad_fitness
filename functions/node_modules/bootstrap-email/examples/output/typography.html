...
<table valign="top" class="body" border="0" cellpadding="0" cellspacing="0" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; border-spacing: 0px; border-collapse: collapse; margin: 0; Margin: 0; padding: 0; border: 0; outline: 0; width: 100%; min-width: 100%; height: 100%; -webkit-text-size-adjust: 100%; -ms-text-size-adjust: 100%; font-family: Helvetica,Arial,sans-serif; line-height: 24px; font-weight: normal; font-size: 16px; -moz-box-sizing: border-box; -webkit-box-sizing: border-box; box-sizing: border-box;" width="100%" height="100%">
	...
	<tr>
		<td valign="top" style="line-height: 24px; font-size: 16px; margin: 0; border-spacing: 0px; border-collapse: collapse;">
			...
			<h1 style="margin-top: 0; margin-bottom: 0; font-weight: 400; color: inherit; text-align: left; vertical-align: baseline; font-size: 36px; line-height: 46.8px;">This is an h1</h1>
<h2 style="margin-top: 0; margin-bottom: 0; font-weight: 400; color: inherit; text-align: left; vertical-align: baseline; font-size: 32px; line-height: 41.6px;">This is an h2</h2>
<h3 style="margin-top: 0; margin-bottom: 0; font-weight: 400; color: inherit; text-align: left; vertical-align: baseline; font-size: 28px; line-height: 36.4px;">This is an h3</h3>
<h4 style="margin-top: 0; margin-bottom: 0; font-weight: 400; color: inherit; text-align: left; vertical-align: baseline; font-size: 24px; line-height: 31.2px;">This is an h4</h4>
<h5 style="margin-top: 0; margin-bottom: 0; font-weight: 400; color: inherit; text-align: left; vertical-align: baseline; font-size: 20px; line-height: 26px;">This is an h5</h5>
<h6 style="margin-top: 0; margin-bottom: 0; font-weight: 400; color: inherit; text-align: left; vertical-align: baseline; font-size: 16px; line-height: 20.8px;">This is an h6</h6>
...
<table class="text-left w-100" border="0" cellpadding="0" cellspacing="0" style="font-family: Helvetica,Arial,sans-serif; mso-table-lspace: 0pt; mso-table-rspace: 0pt; border-spacing: 0px; border-collapse: collapse; width: 100%; text-align: left;" width="100%" align="left"><tbody><tr><td style="line-height: 24px; font-size: 16px; margin: 0; border-spacing: 0px; border-collapse: collapse;">This text is to the left</td></tr></tbody></table>
<table class="text-center w-100" border="0" cellpadding="0" cellspacing="0" style="font-family: Helvetica,Arial,sans-serif; mso-table-lspace: 0pt; mso-table-rspace: 0pt; border-spacing: 0px; border-collapse: collapse; width: 100%; text-align: center;" width="100%" align="center"><tbody><tr><td style="line-height: 24px; font-size: 16px; margin: 0; border-spacing: 0px; border-collapse: collapse;">This text is to the center</td></tr></tbody></table>
<table class="text-right w-100" border="0" cellpadding="0" cellspacing="0" style="font-family: Helvetica,Arial,sans-serif; mso-table-lspace: 0pt; mso-table-rspace: 0pt; border-spacing: 0px; border-collapse: collapse; width: 100%; text-align: right;" width="100%" align="right"><tbody><tr><td style="line-height: 24px; font-size: 16px; margin: 0; border-spacing: 0px; border-collapse: collapse;">This text is to the right</td></tr></tbody></table>
...
<span>This is regular text</span>
<span class="text-muted" style="color: #636c72;">This is muted text</span>
<span class="text-primary" style="color: #007bff;">This is primary text</span>
<span class="text-info" style="color: #17a2b8;">This is info text</span>
<span class="text-success" style="color: #28a745;">This is success text</span>
<span class="text-warning" style="color: #ffc107;">This is warning text</span>
<span class="text-danger" style="color: #dc3545;">This is danger text</span>
<span class="text-light" style="color: #f8f9fa;">This is light text</span>
<span class="text-dark" style="color: #343a40;">This is dark text</span>
...
<p style="line-height: 24px; font-size: 16px; margin: 0; width: 100%;"><strong>Bold Text</strong></p>
<p style="line-height: 24px; font-size: 16px; margin: 0; width: 100%;"><u>Underlined Text</u></p>
<p style="line-height: 24px; font-size: 16px; margin: 0; width: 100%;"><em>Italic Text</em></p>
<p style="line-height: 24px; font-size: 16px; margin: 0; width: 100%;"><s>Strike Through Text</s></p>
